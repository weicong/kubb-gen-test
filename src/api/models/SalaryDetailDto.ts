export type SalaryDetailDto = {
    ...
    */
    ...
    /**
    * @description 批次 - 日期（年-月）
    * @type string | undefined date-time
    */
    salaryBatchDate?: string | undefined;
    /**
    * @type string | undefined
    */
    salaryBatchDateLabel?: string | undefined;
    /**
    * @description 批次 - 基础系数（基础任务 - 奖金系数）
    * @type number | undefined double
    */
    salaryBatchCoefficient1?: number | undefined;
    /**
    * @description 批次 - 责任系数（责任津贴 - 奖金系数）
    * @type number | undefined double
    */
    salaryBatchCoefficient2?: number | undefined;
    /**
    * @description 批次 - 岗位系数（岗位补贴 - 岗位系数）
    * @type number | undefined double
    */
    salaryBatchCoefficient3?: number | undefined;
    /**
    * @description 科室Id
    * @type integer | undefined int64
    */
