import type { GetAssetFixedStatsOutput } from "../GetAssetFixedStatsOutput";

export type GetAssetFixedStatsQueryParams = {
    /**
...
* @description Success
*/
export type GetAssetFixedStatsResponse = GetAssetFixedStatsOutput;
