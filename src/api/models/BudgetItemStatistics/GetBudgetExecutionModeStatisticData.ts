...
export type GetBudgetExecutionModeStatisticDataQueryParams = {
    /**
    * @description 预算计划Id
...
* @description Success
*/
export type GetBudgetExecutionModeStatisticDataResponse = ListResultDtoOfNameValueDtoOfDecimal;
