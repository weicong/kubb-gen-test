...
import type { GetResponse, GetQueryParams } from "../../models/EvaluationCategory/Get";

        export const getQueryKey = (params?: GetQueryParams) => [`/api/services/app/EvaluationCategory/Get`, ...(params ? [params] : [])] as const;
        ...
        export function getQueryOptions <TData = GetResponse>(params?: GetQueryParams): QueryOptions<TData> {
          ...
          return {
            ...
            queryFn: () => {
              return client<TData>({
                method: "get",
                url: `/api/services/app/EvaluationCategory/Get`,
                params
              });
            },
          };
        ...
        /**
* @link /api/services/app/EvaluationCategory/Get
*/
