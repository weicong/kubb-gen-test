...
import type { GetRecordCountStatisticsResponse, GetRecordCountStatisticsQueryParams } from "../../models/PayBill/GetRecordCountStatistics";
        ...
        export const getRecordCountStatisticsQueryKey = (params?: GetRecordCountStatisticsQueryParams) => [`/api/services/app/PayBill/GetRecordCountStatistics`, ...(params ? [params] : [])] as const;
