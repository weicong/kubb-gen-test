...
import type { GetRecordCountStatisticsResponse, GetRecordCountStatisticsQueryParams } from "../../models/Budget/GetRecordCountStatistics";
        ...
        export const getRecordCountStatisticsQueryKey = (params?: GetRecordCountStatisticsQueryParams) => [`/api/services/app/Budget/GetRecordCountStatistics`, ...(params ? [params] : [])] as const;
