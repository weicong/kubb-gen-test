...
import type { GetRecordCountStatisticsResponse, GetRecordCountStatisticsQueryParams } from "../../models/PurchaseApply/GetRecordCountStatistics";
        ...
        export const getRecordCountStatisticsQueryKey = (params?: GetRecordCountStatisticsQueryParams) => [`/api/services/app/PurchaseApply/GetRecordCountStatistics`, ...(params ? [params] : [])] as const;
