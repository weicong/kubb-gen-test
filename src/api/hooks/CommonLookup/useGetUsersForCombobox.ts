...
import type { GetUsersForComboboxResponse, GetUsersForComboboxQueryParams } from "../../models/CommonLookup/GetUsersForCombobox";
        ...
        export const getUsersForComboboxQueryKey = (params?: GetUsersForComboboxQueryParams) => [`/api/services/app/CommonLookup/GetUsersForCombobox`, ...(params ? [params] : [])] as const;
