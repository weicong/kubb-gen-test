...
import type { GetOrganizationUnitsForComboboxResponse, GetOrganizationUnitsForComboboxQueryParams } from "../../models/CommonLookup/GetOrganizationUnitsForCombobox";
        ...
        export const getOrganizationUnitsForComboboxQueryKey = (params?: GetOrganizationUnitsForComboboxQueryParams) => [`/api/services/app/CommonLookup/GetOrganizationUnitsForCombobox`, ...(params ? [params] : [])] as const;
