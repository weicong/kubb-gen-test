...
import type { GetRecordCountStatisticsResponse, GetRecordCountStatisticsQueryParams } from "../../models/SalaryBatchOrganizationUnitInfo/GetRecordCountStatistics";
        ...
        export const getRecordCountStatisticsQueryKey = (params?: GetRecordCountStatisticsQueryParams) => [`/api/services/app/SalaryBatchOrganizationUnitInfo/GetRecordCountStatistics`, ...(params ? [params] : [])] as const;
