...
import type { GetAllResponse, GetAllQueryParams } from "../../models/FundSource/GetAll";

        export const getAllQueryKey = (params?: GetAllQueryParams) => [`/api/services/app/FundSource/GetAll`, ...(params ? [params] : [])] as const;
        ...
        export function getAllQueryOptions <TData = GetAllResponse>(params?: GetAllQueryParams): QueryOptions<TData> {
          ...
          return {
            ...
            queryFn: () => {
              return client<TData>({
                method: "get",
                url: `/api/services/app/FundSource/GetAll`,
                params
              });
            },
          };
        ...
        /**
* @summary 获取全部
* @link /api/services/app/FundSource/GetAll
*/
