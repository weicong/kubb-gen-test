...
import type { GetAllResponse, GetAllQueryParams } from "../../models/Blog/GetAll";

        export const getAllQueryKey = (params?: GetAllQueryParams) => [`/api/services/app/Blog/GetAll`, ...(params ? [params] : [])] as const;
        ...
        export function getAllQueryOptions <TData = GetAllResponse>(params?: GetAllQueryParams): QueryOptions<TData> {
          ...
          return {
            ...
            queryFn: () => {
              return client<TData>({
                method: "get",
                url: `/api/services/app/Blog/GetAll`,
                params
              });
            },
          };
        ...
        /**
* @summary 获取全部
* @link /api/services/app/Blog/GetAll
*/
