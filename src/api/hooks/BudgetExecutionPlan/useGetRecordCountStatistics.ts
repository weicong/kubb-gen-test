...
import type { GetRecordCountStatisticsResponse, GetRecordCountStatisticsQueryParams } from "../../models/BudgetExecutionPlan/GetRecordCountStatistics";
        ...
        export const getRecordCountStatisticsQueryKey = (params?: GetRecordCountStatisticsQueryParams) => [`/api/services/app/BudgetExecutionPlan/GetRecordCountStatistics`, ...(params ? [params] : [])] as const;
