...
import type { GetRecordCountStatisticsResponse, GetRecordCountStatisticsQueryParams } from "../../models/BudgetAllocationOrganizationUnitQuarterStatus/GetRecordCountStatistics";
        ...
        export const getRecordCountStatisticsQueryKey = (params?: GetRecordCountStatisticsQueryParams) => [`/api/services/app/BudgetAllocationOrganizationUnitQuarterStatus/GetRecordCountStatistics`, ...(params ? [params] : [])] as const;
